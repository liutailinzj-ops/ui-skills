...
2. Infer one of the three production scenarios, then derive site model, build route, strategy source, reference role, theme state, content state, asset route, requested page, and website language. Display one compact Chinese project-recognition card and continue when the route is clear.
...
4. Load `$iwish-page-strategy`. Complete product, category, competitor, DTC conversion-chain or B2B buying-path analysis and the product-specific Content Strategy Contract before selecting page structure. For selected competitor-module work, keep selected-module sources separate from theme-capability and competitor-evidence sources, then produce the selected-module specification, Theme Capability Map, content cards, and complete page blueprint.
...
- The active component library is arranged in aligned Auto Layout categories and family rows; UI does not need to reorganize masters before editing.
