...
- A `reference_to_theme` run has a verified Source Identity Fingerprint, Source Page Specification, and cross-source Theme Assembly Plan; Build Truth URL identity, product/category identity, source section count, order, content-item coverage, Desktop/Mobile layout-class coverage, and mapping status pass at 100% unless a deviation is explicitly approved.
