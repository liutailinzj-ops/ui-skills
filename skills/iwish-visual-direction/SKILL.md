...
description: Translate an IWISH product/competitor analysis, page blueprint, brand inputs, references, and theme constraints into a project-specific website visual direction and representative editable Desktop/Mobile Figma compositions. Use between page strategy and full-page production for Shopify or WordPress template, theme-customized, and fully custom DTC/B2B work, especially when incomplete assets or reference-to-theme translation could otherwise collapse into generic wireframes.
---
...
3. Define one primary art direction: brand character, typography, color behavior, imagery, media crop, density, spacing rhythm, grid behavior, card language, controls, motion or interaction cues, and Desktop/Mobile transformation.
...
7. Read [references/representative-compositions.md](references/representative-compositions.md) and create representative editable Desktop/Mobile compositions on an internal visual-direction page. Use the actual website language for rendered website content and Chinese for visible internal annotations.
...
- Desktop and Mobile representative-composition node IDs.
