...
Use the customer's competitor/reference URLs first. Supplement them with current first-party sites from the same category and target market.
...
- Navigation and discovery model.
